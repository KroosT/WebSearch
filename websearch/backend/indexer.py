...
class Indexer:
    ...
    def __init__(self, words_in_file):
        self.words_in_file = words_in_file
        self.index = {}
        self.build_index(self.words_in_files)
    ...
    def build_index(self, words_in_file):
        for filename in words_in_file:
            for word in words_in_file[filename].keys():
